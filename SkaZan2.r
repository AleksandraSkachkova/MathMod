...
summary(1:10)[4]
# Задание 3
##Посчитать долю каждого нуклеотида в векторе содержащем последовательность ДНК
...
cumsum(1:10)
# Задание 4
##Создать длинные последовательности с заданными пропорциями элементов
